...
public class FilterClientForm {
    ...
    public FilterClientForm() {
        ...
        frame.setIconImage(new ImageIcon(com.javafee.java.lessons.CrudApp.view.FilterClientForm.class.
                getResource("/btnLogOut-ico.png")).getImage());
        frame.setContentPane(panel);
        frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        frame.pack();
        buttonFilter.setIcon(new ImageIcon(new ImageIcon(com.javafee.java.lessons.CrudApp.view.FilterClientForm.class.getResource("/btnAccept-ico.png"))
